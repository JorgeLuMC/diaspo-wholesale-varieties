...
const DetailsPage = (props) => {
  ...
  const submitReview = async (e) => {
    ...
    try {
      await axios
        .post("http://localhost:3006/productReviews", reviewFields)
        .then((response) => {
  ...
  const showReviews = async () => {
    try {
      await axios
        .get("http://localhost:3006/productReviews")
        .then((response) => {
          ...
          <div className="breadcrumbWrapper mb-4">
            <div className="container-fluid">
              <ul className="breadcrumb breadcrumb2 mb-0">
                ...
                <li>
                  <Link
                    to={`/${prodCat.parentCat.toLowerCase()}/${prodCat.subCatName
                      .replace(/\s/g, "-")
                      .toLowerCase()}`}
                    onClick={() =>
                      sessionStorage.setItem(
